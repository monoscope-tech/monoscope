  ...
  class i {
    ...
    getCalendarHeaderView(t) {
      ...
      ;(i.className = 'month-name'),
        (i.innerHTML = `<span>${t.toLocaleString(this.picker.options.lang, { month: 'long' })}</span> ${t.format('YYYY')}`),
        e.appendChild(i)
      const n = document.createElement('button')
  ...
  class s {
    ...
    onClickHeaderButton(t) {
      this.isCalendarHeaderButton(t) &&
        (t.classList.contains('next-button') ? this.calendars[0].add(1, 'month') : this.calendars[0].subtract(1, 'month'), this.renderAll(this.calendars[0]))
    }
    ...
    parseValues() {
      this.options.date
        ...
        : this.options.element instanceof HTMLInputElement && this.options.element.value.length && this.setDate(this.options.element.value),
    ...
    (t.LockPlugin = class extends a {
      ...
      onView(t) {
        ...
        if (this.options.presets && 'PresetPluginButton' === i) {
          ...
          ;(o || a || this.lockMinDate(t) || this.lockMaxDate(t) || this.lockMinDate(i) || this.lockMaxDate(i) || this.rangeIsNotAvailable(t, i)) &&
      ...
      onInput(t) {
        ...
        if (i instanceof HTMLInputElement && i.classList.contains('time-plugin-input')) {
          ...
          t.setHours(Number(n) || 0, Number(s) || 0, 0, 0),
            this.picker.options.autoApply ? ((this.timePicked[i.name] = t), this.picker.updateValues()) : (this.timePrePicked[i.name] = t)
        }
      }
      onChange(t) {
        const i = t.target
