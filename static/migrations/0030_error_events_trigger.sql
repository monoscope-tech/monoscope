...
BEGIN
  ...
  IF NEW.error_data IS NOT NULL AND NEW.error_data != '{}'::jsonb THEN
    INSERT INTO apis.error_events (
      ...
      NEW.hash,
      COALESCE(NEW.error_data->>'root_error_type', NEW.error_data->>'error_type', NEW.exception_type),
      COALESCE(NEW.error_data->>'root_error_message', NEW.error_data->>'message', NEW.message),
