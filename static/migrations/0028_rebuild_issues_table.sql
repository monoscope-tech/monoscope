...
ALTER TYPE apis.issue_type ADD VALUE IF NOT EXISTS 'new_error';
ALTER TYPE apis.issue_type ADD VALUE IF NOT EXISTS 'new_log_pattern';
ALTER TYPE apis.issue_type ADD VALUE IF NOT EXISTS 'api-change';
...
ALTER TYPE apis.issue_type ADD VALUE IF NOT EXISTS 'alert-triggered';
...
CREATE TABLE apis.issues (
    ...
    source_type         TEXT NOT NULL,              -- 'error', 'log_pattern', 'endpoint'
