...
Expand a request and trace its entire journey: the gRPC call to your payment service, the HTTP call it made to Stripe, the logs it wrote along the way, and the SQL query that updated the order. All in one tree.
