...
newtype AnyValue
  = AnyValue {anyValueValue :: (Hs.Maybe AnyValueValue)}
         ...
         Hs.Just x
           -> case x of
                ...
                AnyValueValueBoolValue y
                  -> HsProtobuf.encodeMessageField
                       (HsProtobuf.FieldNumber 2) (HsProtobuf.ForceEmit y)
           ...
           -> Hs.pure AnyValue
                <*>
                  (let
                     parseValue parseObj
                       = Hs.msum
                           [Hs.Just Hs.. AnyValueValueStringValue
                            ...
                            Hs.Just Hs.. AnyValueValueBytesValue
...
instance (HsJSONPB.ToSchema AnyValueValue) where
  declareNamedSchema _
    = do let declare_string_value = HsJSONPB.declareSchemaRef
         anyValueValueStringValue <- declare_string_value Proxy.Proxy
         let _ = Hs.pure AnyValueValueStringValue
                   <*>
                     ((HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @Hs.Text)
         ...
         let _ = Hs.pure AnyValueValueBoolValue
         ...
         let _ = Hs.pure AnyValueValueIntValue
         ...
         let _ = Hs.pure AnyValueValueDoubleValue
         ...
         let _ = Hs.pure AnyValueValueArrayValue
         ...
         let _ = Hs.pure AnyValueValueKvlistValue
         ...
         let _ = Hs.pure AnyValueValueBytesValue
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.Bytes Hs.ByteString) @Hs.ByteString)
...
newtype ArrayValue
  = ArrayValue {arrayValueValues :: (Hs.Vector Opentelemetry.Proto.Common.V1.Common.AnyValue)}
  deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)
...
newtype KeyValueList
  = KeyValueList {keyValueListValues :: (Hs.Vector Opentelemetry.Proto.Common.V1.Common.KeyValue)}
  deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)
...
data InstrumentationScope
  = InstrumentationScope {instrumentationScopeName :: Hs.Text,
...
instance (HsProtobuf.Message InstrumentationScope) where
  encodeMessage
    ...
    InstrumentationScope {instrumentationScopeName,
                          instrumentationScopeVersion, instrumentationScopeAttributes,
...
instance (HsJSONPB.ToSchema InstrumentationScope) where
  declareNamedSchema _
    = do let declare_name = HsJSONPB.declareSchemaRef
         ...
         instrumentationScopeDroppedAttributesCount <- declare_dropped_attributes_count
                                                         Proxy.Proxy
         let _ = Hs.pure InstrumentationScope
                   <*>
                     ((HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @Hs.Text)
