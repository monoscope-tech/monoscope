...
newtype LogsData
  = LogsData {logsDataResourceLogs :: (Hs.Vector Opentelemetry.Proto.Logs.V1.Logs.ResourceLogs)}
                                              ...
                                              {HsJSONPB._schemaParamSchema = Hs.mempty
                                               ...
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("resource_logs", 
                                                                                logsDataResourceLogs)]}}
data ResourceLogs
  = ResourceLogs {resourceLogsResource :: (Hs.Maybe Opentelemetry.Proto.Resource.V1.Resource.Resource),
...
instance (HsProtobuf.Message ResourceLogs) where
  encodeMessage
    _
    ResourceLogs {resourceLogsResource, resourceLogsScopeLogs,
                                               ...
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("resource", 
                                                                               ...
                                                                               ("schema_url", 
                                                                                resourceLogsSchemaUrl)]}}
data ScopeLogs
  = ScopeLogs {scopeLogsScope :: (Hs.Maybe Opentelemetry.Proto.Common.V1.Common.InstrumentationScope),
...
data LogRecord
  = LogRecord {logRecordTimeUnixNano :: Hs.Word64,
...
instance (HsProtobuf.Message LogRecord) where
  encodeMessage
    _
    LogRecord {logRecordTimeUnixNano, logRecordObservedTimeUnixNano,
               logRecordSeverityNumber, logRecordSeverityText, logRecordBody,
               logRecordAttributes, logRecordDroppedAttributesCount,
               logRecordFlags, logRecordTraceId, logRecordSpanId}
    = Hs.mappend
        (Hs.mappend
           (Hs.mappend
              (Hs.mappend
                 (Hs.mappend
                    (Hs.mappend
                       (Hs.mappend
                          (Hs.mappend
                             ...
                             (HsProtobuf.encodeMessageField
                                (HsProtobuf.FieldNumber 2) logRecordSeverityNumber))
                          (HsProtobuf.encodeMessageField
                             (HsProtobuf.FieldNumber 3)
                             ((Hs.coerce @Hs.Text @(HsProtobuf.String Hs.Text))
                    ...
                    (HsProtobuf.encodeMessageField
                       ...
                       ((Hs.coerce
                          ...
                          logRecordAttributes)))
                 (HsProtobuf.encodeMessageField
                    (HsProtobuf.FieldNumber 7) logRecordDroppedAttributesCount))
              (HsProtobuf.encodeMessageField
  ...
  dotProto _
    = [HsProtobufAST.DotProtoField
       ...
       HsProtobufAST.DotProtoField
         (HsProtobuf.FieldNumber 9) (HsProtobufAST.Prim HsProtobufAST.Bytes)
...
instance (HsJSONPB.ToSchema LogRecord) where
  declareNamedSchema _
    = do let declare_time_unix_nano = HsJSONPB.declareSchemaRef
         ...
         logRecordObservedTimeUnixNano <- declare_observed_time_unix_nano
                                            Proxy.Proxy
         ...
         logRecordDroppedAttributesCount <- declare_dropped_attributes_count
                                              Proxy.Proxy
