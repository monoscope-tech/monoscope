...
import Network.GRPC.HighLevel.Server.Unregistered as HsGRPC
    ( serverLoop )
import qualified Opentelemetry.Proto.Profiles.V1experimental.Profiles
newtype ProfilesService request response
  = ProfilesService {profilesServiceExport :: ((request 'HsGRPC.Normal Opentelemetry.Proto.Collector.Profiles.V1experimental.ProfilesService.ExportProfilesServiceRequest Opentelemetry.Proto.Collector.Profiles.V1experimental.ProfilesService.ExportProfilesServiceResponse)
        ...
        (Hs.pure (HsGRPC.clientRequest client)
           <*>
             HsGRPC.clientRegisterMethod
               ...
               (HsGRPC.MethodName
                  "/opentelemetry.proto.collector.profiles.v1experimental.ProfilesService/Export"))
newtype ExportProfilesServiceRequest
  = ExportProfilesServiceRequest {exportProfilesServiceRequestResourceProfiles :: (Hs.Vector Opentelemetry.Proto.Profiles.V1experimental.Profiles.ResourceProfiles)}
            ...
            (HsProtobufAST.Named
               (HsProtobufAST.Dots
                  (HsProtobufAST.Path
                     ("opentelemetry"
                        Hs.:|
                          ["proto", "profiles", "v1experimental", "ResourceProfiles"])))))
...
instance (HsJSONPB.ToSchema ExportProfilesServiceRequest) where
  declareNamedSchema _
    = do let declare_resource_profiles = HsJSONPB.declareSchemaRef
         exportProfilesServiceRequestResourceProfiles <- declare_resource_profiles
                                                           Proxy.Proxy
         let _ = Hs.pure ExportProfilesServiceRequest
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.NestedVec Opentelemetry.Proto.Profiles.V1experimental.Profiles.ResourceProfiles)
                         @(Hs.Vector Opentelemetry.Proto.Profiles.V1experimental.Profiles.ResourceProfiles))
              ...
              HsJSONPB._namedSchemaSchema = Hs.mempty
                                              {HsJSONPB._schemaParamSchema = Hs.mempty
                                               ...
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("resource_profiles", 
                                                                                exportProfilesServiceRequestResourceProfiles)]}}
newtype ExportProfilesServiceResponse
  = ExportProfilesServiceResponse {exportProfilesServiceResponsePartialSuccess :: (Hs.Maybe Opentelemetry.Proto.Collector.Profiles.V1experimental.ProfilesService.ExportProfilesPartialSuccess)}
  deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)
...
instance (HsJSONPB.ToSchema ExportProfilesServiceResponse) where
  declareNamedSchema _
    = do let declare_partial_success = HsJSONPB.declareSchemaRef
         exportProfilesServiceResponsePartialSuccess <- declare_partial_success
                                                          Proxy.Proxy
         let _ = Hs.pure ExportProfilesServiceResponse
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.Nested Opentelemetry.Proto.Collector.Profiles.V1experimental.ProfilesService.ExportProfilesPartialSuccess)
                         @(Hs.Maybe Opentelemetry.Proto.Collector.Profiles.V1experimental.ProfilesService.ExportProfilesPartialSuccess))
...
data ExportProfilesPartialSuccess
  = ExportProfilesPartialSuccess {exportProfilesPartialSuccessRejectedProfiles :: Hs.Int64,
...
instance (HsProtobuf.Message ExportProfilesPartialSuccess) where
  encodeMessage
    _
    ExportProfilesPartialSuccess {exportProfilesPartialSuccessRejectedProfiles,
...
instance (HsJSONPB.ToSchema ExportProfilesPartialSuccess) where
  declareNamedSchema _
    = do let declare_rejected_profiles = HsJSONPB.declareSchemaRef
         exportProfilesPartialSuccessRejectedProfiles <- declare_rejected_profiles
                                                           Proxy.Proxy
         let declare_error_message = HsJSONPB.declareSchemaRef
         exportProfilesPartialSuccessErrorMessage <- declare_error_message
                                                       Proxy.Proxy
         let _ = Hs.pure ExportProfilesPartialSuccess
