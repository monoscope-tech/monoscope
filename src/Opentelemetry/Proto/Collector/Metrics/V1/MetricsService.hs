...
import Network.GRPC.HighLevel.Server.Unregistered as HsGRPC
    ( serverLoop )
import qualified Opentelemetry.Proto.Metrics.V1.Metrics
newtype MetricsService request response
  = MetricsService {metricsServiceExport :: ((request 'HsGRPC.Normal Opentelemetry.Proto.Collector.Metrics.V1.MetricsService.ExportMetricsServiceRequest Opentelemetry.Proto.Collector.Metrics.V1.MetricsService.ExportMetricsServiceResponse)
        ...
        (Hs.pure (HsGRPC.clientRequest client)
           <*>
             HsGRPC.clientRegisterMethod
               ...
               (HsGRPC.MethodName
                  "/opentelemetry.proto.collector.metrics.v1.MetricsService/Export"))
newtype ExportMetricsServiceRequest
  = ExportMetricsServiceRequest {exportMetricsServiceRequestResourceMetrics :: (Hs.Vector Opentelemetry.Proto.Metrics.V1.Metrics.ResourceMetrics)}
...
instance (HsJSONPB.ToSchema ExportMetricsServiceRequest) where
  declareNamedSchema _
    = do let declare_resource_metrics = HsJSONPB.declareSchemaRef
         exportMetricsServiceRequestResourceMetrics <- declare_resource_metrics
                                                         Proxy.Proxy
         let _ = Hs.pure ExportMetricsServiceRequest
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.NestedVec Opentelemetry.Proto.Metrics.V1.Metrics.ResourceMetrics)
                         @(Hs.Vector Opentelemetry.Proto.Metrics.V1.Metrics.ResourceMetrics))
              ...
              HsJSONPB._namedSchemaSchema = Hs.mempty
                                              {HsJSONPB._schemaParamSchema = Hs.mempty
                                               ...
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("resource_metrics", 
                                                                                exportMetricsServiceRequestResourceMetrics)]}}
newtype ExportMetricsServiceResponse
  = ExportMetricsServiceResponse {exportMetricsServiceResponsePartialSuccess :: (Hs.Maybe Opentelemetry.Proto.Collector.Metrics.V1.MetricsService.ExportMetricsPartialSuccess)}
  deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)
...
instance (HsJSONPB.ToSchema ExportMetricsServiceResponse) where
  declareNamedSchema _
    = do let declare_partial_success = HsJSONPB.declareSchemaRef
         exportMetricsServiceResponsePartialSuccess <- declare_partial_success
                                                         Proxy.Proxy
         let _ = Hs.pure ExportMetricsServiceResponse
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.Nested Opentelemetry.Proto.Collector.Metrics.V1.MetricsService.ExportMetricsPartialSuccess)
                         @(Hs.Maybe Opentelemetry.Proto.Collector.Metrics.V1.MetricsService.ExportMetricsPartialSuccess))
...
data ExportMetricsPartialSuccess
  = ExportMetricsPartialSuccess {exportMetricsPartialSuccessRejectedDataPoints :: Hs.Int64,
...
instance (HsProtobuf.Message ExportMetricsPartialSuccess) where
  encodeMessage
    _
    ExportMetricsPartialSuccess {exportMetricsPartialSuccessRejectedDataPoints,
...
instance (HsJSONPB.ToSchema ExportMetricsPartialSuccess) where
  declareNamedSchema _
    = do let declare_rejected_data_points = HsJSONPB.declareSchemaRef
         exportMetricsPartialSuccessRejectedDataPoints <- declare_rejected_data_points
                                                            Proxy.Proxy
         let declare_error_message = HsJSONPB.declareSchemaRef
         exportMetricsPartialSuccessErrorMessage <- declare_error_message
                                                      Proxy.Proxy
         let _ = Hs.pure ExportMetricsPartialSuccess
