...
import Network.GRPC.HighLevel.Server.Unregistered as HsGRPC
    ( serverLoop )
import qualified Opentelemetry.Proto.Logs.V1.Logs
newtype LogsService request response
  = LogsService {logsServiceExport :: ((request 'HsGRPC.Normal Opentelemetry.Proto.Collector.Logs.V1.LogsService.ExportLogsServiceRequest Opentelemetry.Proto.Collector.Logs.V1.LogsService.ExportLogsServiceResponse)
        ...
        (Hs.pure (HsGRPC.clientRequest client)
           <*>
             HsGRPC.clientRegisterMethod
               ...
               (HsGRPC.MethodName
                  "/opentelemetry.proto.collector.logs.v1.LogsService/Export"))
newtype ExportLogsServiceRequest
  = ExportLogsServiceRequest {exportLogsServiceRequestResourceLogs :: (Hs.Vector Opentelemetry.Proto.Logs.V1.Logs.ResourceLogs)}
...
instance (HsJSONPB.ToSchema ExportLogsServiceRequest) where
  declareNamedSchema _
    = do let declare_resource_logs = HsJSONPB.declareSchemaRef
         exportLogsServiceRequestResourceLogs <- declare_resource_logs
                                                   Proxy.Proxy
         let _ = Hs.pure ExportLogsServiceRequest
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.NestedVec Opentelemetry.Proto.Logs.V1.Logs.ResourceLogs)
                         @(Hs.Vector Opentelemetry.Proto.Logs.V1.Logs.ResourceLogs))
              ...
              HsJSONPB._namedSchemaSchema = Hs.mempty
                                              {HsJSONPB._schemaParamSchema = Hs.mempty
                                               ...
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("resource_logs", 
                                                                                exportLogsServiceRequestResourceLogs)]}}
newtype ExportLogsServiceResponse
  = ExportLogsServiceResponse {exportLogsServiceResponsePartialSuccess :: (Hs.Maybe Opentelemetry.Proto.Collector.Logs.V1.LogsService.ExportLogsPartialSuccess)}
  deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)
...
instance (HsJSONPB.ToSchema ExportLogsServiceResponse) where
  declareNamedSchema _
    = do let declare_partial_success = HsJSONPB.declareSchemaRef
         exportLogsServiceResponsePartialSuccess <- declare_partial_success
                                                      Proxy.Proxy
         let _ = Hs.pure ExportLogsServiceResponse
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.Nested Opentelemetry.Proto.Collector.Logs.V1.LogsService.ExportLogsPartialSuccess)
                         @(Hs.Maybe Opentelemetry.Proto.Collector.Logs.V1.LogsService.ExportLogsPartialSuccess))
...
data ExportLogsPartialSuccess
  = ExportLogsPartialSuccess {exportLogsPartialSuccessRejectedLogRecords :: Hs.Int64,
...
instance (HsProtobuf.Message ExportLogsPartialSuccess) where
  encodeMessage
    _
    ExportLogsPartialSuccess {exportLogsPartialSuccessRejectedLogRecords,
...
instance (HsJSONPB.ToSchema ExportLogsPartialSuccess) where
  declareNamedSchema _
    = do let declare_rejected_log_records = HsJSONPB.declareSchemaRef
         exportLogsPartialSuccessRejectedLogRecords <- declare_rejected_log_records
                                                         Proxy.Proxy
         let declare_error_message = HsJSONPB.declareSchemaRef
         exportLogsPartialSuccessErrorMessage <- declare_error_message
                                                   Proxy.Proxy
         let _ = Hs.pure ExportLogsPartialSuccess
