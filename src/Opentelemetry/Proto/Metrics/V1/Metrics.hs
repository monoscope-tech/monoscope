...
newtype MetricsData
  = MetricsData {metricsDataResourceMetrics :: (Hs.Vector Opentelemetry.Proto.Metrics.V1.Metrics.ResourceMetrics)}
...
instance (HsJSONPB.ToSchema MetricsData) where
  declareNamedSchema _
    = do let declare_resource_metrics = HsJSONPB.declareSchemaRef
         metricsDataResourceMetrics <- declare_resource_metrics Proxy.Proxy
         let _ = Hs.pure MetricsData
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.NestedVec Opentelemetry.Proto.Metrics.V1.Metrics.ResourceMetrics)
                         @(Hs.Vector Opentelemetry.Proto.Metrics.V1.Metrics.ResourceMetrics))
...
data ResourceMetrics
  = ResourceMetrics {resourceMetricsResource :: (Hs.Maybe Opentelemetry.Proto.Resource.V1.Resource.Resource),
...
instance (HsProtobuf.Message ResourceMetrics) where
  encodeMessage
    _
    ResourceMetrics {resourceMetricsResource,
                     resourceMetricsScopeMetrics, resourceMetricsSchemaUrl}
    = Hs.mappend
        (Hs.mappend
           (HsProtobuf.encodeMessageField
              (HsProtobuf.FieldNumber 1)
                                               ...
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("resource", 
                                                                               ...
                                                                               ("schema_url", 
                                                                                resourceMetricsSchemaUrl)]}}
data ScopeMetrics
  = ScopeMetrics {scopeMetricsScope :: (Hs.Maybe Opentelemetry.Proto.Common.V1.Common.InstrumentationScope),
...
instance (HsProtobuf.Message ScopeMetrics) where
  encodeMessage
    _
    ScopeMetrics {scopeMetricsScope, scopeMetricsMetrics,
...
instance (HsProtobuf.Message Metric) where
  encodeMessage
    _
    Metric {metricName, metricDescription, metricUnit, metricData,
            metricMetadata}
    = Hs.mappend
        (Hs.mappend
           (Hs.mappend
...
instance (HsJSONPB.ToSchema MetricData) where
  declareNamedSchema _
    = do let declare_gauge = HsJSONPB.declareSchemaRef
         ...
         let _ = Hs.pure MetricDataHistogram
                   <*> HsJSONPB.asProxy declare_histogram
         let declare_exponential_histogram = HsJSONPB.declareSchemaRef
         metricDataExponentialHistogram <- declare_exponential_histogram
                                             Proxy.Proxy
         let _ = Hs.pure MetricDataExponentialHistogram
         ...
         let _ = Hs.pure MetricDataSummary
...
newtype Gauge
  = Gauge {gaugeDataPoints :: (Hs.Vector Opentelemetry.Proto.Metrics.V1.Metrics.NumberDataPoint)}
  deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)
...
instance (HsJSONPB.ToSchema Gauge) where
  declareNamedSchema _
    = do let declare_data_points = HsJSONPB.declareSchemaRef
                                              ...
                                              {HsJSONPB._schemaParamSchema = Hs.mempty
                                               ...
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("data_points", 
                                                                                gaugeDataPoints)]}}
data Sum
  = Sum {sumDataPoints :: (Hs.Vector Opentelemetry.Proto.Metrics.V1.Metrics.NumberDataPoint),
        ...
        (Hs.mappend
           (HsProtobuf.encodeMessageField
              ...
              ((Hs.coerce
                 ...
                 sumDataPoints))
           (HsProtobuf.encodeMessageField
              (HsProtobuf.FieldNumber 2) sumAggregationTemporality))
        (HsProtobuf.encodeMessageField
           (HsProtobuf.FieldNumber 3) sumIsMonotonic)
  decodeMessage _
    = Hs.pure Sum
        <*>
          ((HsProtobuf.coerceOver
        ...
        ["data_points"
           .=
             ((Hs.coerce
                 ...
                 @(HsProtobuf.NestedVec Opentelemetry.Proto.Metrics.V1.Metrics.NumberDataPoint))
                f1),
         "aggregation_temporality" .= f2, "is_monotonic" .= f3]
...
instance (HsJSONPB.ToSchema Sum) where
  declareNamedSchema _
    = do let declare_data_points = HsJSONPB.declareSchemaRef
         ...
         sumAggregationTemporality <- declare_aggregation_temporality
                                        Proxy.Proxy
                                               ...
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("data_points", 
                                                                               ...
                                                                               ("is_monotonic", 
                                                                                sumIsMonotonic)]}}
data Histogram
  = Histogram {histogramDataPoints :: (Hs.Vector Opentelemetry.Proto.Metrics.V1.Metrics.HistogramDataPoint),
    ...
    = Hs.mappend
        (HsProtobuf.encodeMessageField
           ...
           ((Hs.coerce
              ...
              histogramDataPoints))
        (HsProtobuf.encodeMessageField
           (HsProtobuf.FieldNumber 2) histogramAggregationTemporality)
  decodeMessage _
    = Hs.pure Histogram
        <*>
          ((HsProtobuf.coerceOver
...
instance (HsJSONPB.ToSchema Histogram) where
  declareNamedSchema _
    = do let declare_data_points = HsJSONPB.declareSchemaRef
         ...
         let declare_aggregation_temporality = HsJSONPB.declareSchemaRef
         histogramAggregationTemporality <- declare_aggregation_temporality
                                              Proxy.Proxy
         let _ = Hs.pure Histogram
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.NestedVec Opentelemetry.Proto.Metrics.V1.Metrics.HistogramDataPoint)
                         @(Hs.Vector Opentelemetry.Proto.Metrics.V1.Metrics.HistogramDataPoint))
...
data ExponentialHistogram
  = ExponentialHistogram {exponentialHistogramDataPoints :: (Hs.Vector Opentelemetry.Proto.Metrics.V1.Metrics.ExponentialHistogramDataPoint),
...
instance (HsProtobuf.Message ExponentialHistogram) where
  encodeMessage
    _
    ExponentialHistogram {exponentialHistogramDataPoints,
...
instance (HsJSONPB.ToSchema ExponentialHistogram) where
  declareNamedSchema _
    = do let declare_data_points = HsJSONPB.declareSchemaRef
         ...
         let declare_aggregation_temporality = HsJSONPB.declareSchemaRef
         exponentialHistogramAggregationTemporality <- declare_aggregation_temporality
                                                         Proxy.Proxy
         let _ = Hs.pure ExponentialHistogram
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.NestedVec Opentelemetry.Proto.Metrics.V1.Metrics.ExponentialHistogramDataPoint)
                         @(Hs.Vector Opentelemetry.Proto.Metrics.V1.Metrics.ExponentialHistogramDataPoint))
                                               ...
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("data_points", 
                                                                               ...
                                                                               ("aggregation_temporality", 
                                                                                exponentialHistogramAggregationTemporality)]}}
newtype Summary
  = Summary {summaryDataPoints :: (Hs.Vector Opentelemetry.Proto.Metrics.V1.Metrics.SummaryDataPoint)}
  deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)
...
data NumberDataPoint
  = NumberDataPoint {numberDataPointAttributes :: (Hs.Vector Opentelemetry.Proto.Common.V1.Common.KeyValue),
...
instance (HsProtobuf.Message NumberDataPoint) where
  encodeMessage
    _
    NumberDataPoint {numberDataPointAttributes,
                     numberDataPointStartTimeUnixNano, numberDataPointTimeUnixNano,
                     numberDataPointValue, numberDataPointExemplars,
    ...
    = Hs.mappend
                        ...
                        NumberDataPointValueAsInt y
                          -> HsProtobuf.encodeMessageField
                               ...
                               (HsProtobuf.ForceEmit
                                  ((Hs.coerce
                                      @Hs.Int64 @(HsProtobuf.Signed (HsProtobuf.Fixed Hs.Int64)))
                                     y))))
           (HsProtobuf.encodeMessageField
              (HsProtobuf.FieldNumber 5)
              ((Hs.coerce
        ...
        (HsProtobuf.encodeMessageField
           (HsProtobuf.FieldNumber 8) numberDataPointFlags)
  decodeMessage _
            ...
            [((HsProtobuf.FieldNumber 4), 
             ...
             ((HsProtobuf.FieldNumber 6), 
              Hs.pure (Hs.Just Hs.. NumberDataPointValueAsInt)
                <*>
                  ((HsProtobuf.coerceOver
                      @(HsProtobuf.Signed (HsProtobuf.Fixed Hs.Int64)) @Hs.Int64)
                     HsProtobuf.decodeMessageField))]
        <*>
          ((HsProtobuf.coerceOver
              @(HsProtobuf.NestedVec Opentelemetry.Proto.Metrics.V1.Metrics.Exemplar)
                     ...
                     parseValue parseObj
                       = Hs.msum
                           [Hs.Just Hs.. NumberDataPointValueAsDouble
                            ...
                            Hs.Just Hs.. NumberDataPointValueAsInt
                              Hs..
                                (Hs.coerce
                                   @(HsProtobuf.Signed (HsProtobuf.Fixed Hs.Int64)) @Hs.Int64)
...
instance (HsJSONPB.ToSchema NumberDataPoint) where
  declareNamedSchema _
    = do let declare_attributes = HsJSONPB.declareSchemaRef
         ...
         numberDataPointStartTimeUnixNano <- declare_start_time_unix_nano
                                               Proxy.Proxy
...
instance (HsJSONPB.ToSchema NumberDataPointValue) where
  declareNamedSchema _
    = do let declare_as_double = HsJSONPB.declareSchemaRef
         numberDataPointValueAsDouble <- declare_as_double Proxy.Proxy
         let _ = Hs.pure NumberDataPointValueAsDouble
         ...
         let _ = Hs.pure NumberDataPointValueAsInt
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.Signed (HsProtobuf.Fixed Hs.Int64)) @Hs.Int64)
...
data HistogramDataPoint
  = HistogramDataPoint {histogramDataPointAttributes :: (Hs.Vector Opentelemetry.Proto.Common.V1.Common.KeyValue),
...
instance (HsProtobuf.Message HistogramDataPoint) where
  encodeMessage
    _
    HistogramDataPoint {histogramDataPointAttributes,
                        histogramDataPointStartTimeUnixNano,
                        histogramDataPointTimeUnixNano, histogramDataPointCount,
                        histogramDataPointSum, histogramDataPointBucketCounts,
                        histogramDataPointExplicitBounds, histogramDataPointExemplars,
                        histogramDataPointFlags, histogramDataPointMin,
    ...
    = Hs.mappend
        (Hs.mappend
           (Hs.mappend
                 ...
                 (Hs.mappend
                    (Hs.mappend
                       (Hs.mappend
                          ...
                          (HsProtobuf.encodeMessageField
                             (HsProtobuf.FieldNumber 5) histogramDataPointSum))
                       (HsProtobuf.encodeMessageField
                          (HsProtobuf.FieldNumber 6)
                          ((Hs.coerce
                              @(Hs.Vector Hs.Word64)
                    ...
                    (HsProtobuf.encodeMessageField
                       (HsProtobuf.FieldNumber 7)
                       ((Hs.coerce
                           @(Hs.Vector Hs.Double) @(HsProtobuf.PackedVec Hs.Double))
              ...
              (HsProtobuf.encodeMessageField
                 (HsProtobuf.FieldNumber 10) histogramDataPointFlags))
           (HsProtobuf.encodeMessageField
              (HsProtobuf.FieldNumber 11) histogramDataPointMin))
        (HsProtobuf.encodeMessageField
           (HsProtobuf.FieldNumber 12) histogramDataPointMax)
  decodeMessage _
    = Hs.pure HistogramDataPoint
        ...
        <*>
          ((HsProtobuf.coerceOver
              @(HsProtobuf.PackedVec Hs.Double) @(Hs.Vector Hs.Double))
             (HsProtobuf.at
                HsProtobuf.decodeMessageField (HsProtobuf.FieldNumber 7)))
        <*>
          ((HsProtobuf.coerceOver
...
instance (HsJSONPB.ToSchema HistogramDataPoint) where
  declareNamedSchema _
    = do let declare_attributes = HsJSONPB.declareSchemaRef
         ...
         let declare_start_time_unix_nano = HsJSONPB.declareSchemaRef
         histogramDataPointStartTimeUnixNano <- declare_start_time_unix_nano
                                                  Proxy.Proxy
         let declare_time_unix_nano = HsJSONPB.declareSchemaRef
         histogramDataPointTimeUnixNano <- declare_time_unix_nano
                                             Proxy.Proxy
         ...
         histogramDataPointExplicitBounds <- declare_explicit_bounds
                                               Proxy.Proxy
         let declare_exemplars = HsJSONPB.declareSchemaRef
         ...
         let _ = Hs.pure HistogramDataPoint
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.NestedVec Opentelemetry.Proto.Common.V1.Common.KeyValue)
                         @(Hs.Vector Opentelemetry.Proto.Common.V1.Common.KeyValue))
...
data ExponentialHistogramDataPoint
  = ExponentialHistogramDataPoint {exponentialHistogramDataPointAttributes :: (Hs.Vector Opentelemetry.Proto.Common.V1.Common.KeyValue),
...
instance (HsProtobuf.Message ExponentialHistogramDataPoint) where
  encodeMessage
    _
    ExponentialHistogramDataPoint {exponentialHistogramDataPointAttributes,
                    ...
                    (Hs.mappend
                                   ...
                                   (Hs.mappend
                                      ...
                                      (HsProtobuf.encodeMessageField
                                         ...
                                         ((Hs.coerce @Hs.Word64 @(HsProtobuf.Fixed Hs.Word64))
                                            exponentialHistogramDataPointCount)))
                                   (HsProtobuf.encodeMessageField
                                      (HsProtobuf.FieldNumber 5) exponentialHistogramDataPointSum))
                                (HsProtobuf.encodeMessageField
                                   (HsProtobuf.FieldNumber 6)
                       ...
                       (HsProtobuf.encodeMessageField
                          ...
                          ((Hs.coerce
                             ...
                             exponentialHistogramDataPointNegative)))
                    (HsProtobuf.encodeMessageField
                       (HsProtobuf.FieldNumber 10) exponentialHistogramDataPointFlags))
                 (HsProtobuf.encodeMessageField
                    (HsProtobuf.FieldNumber 11)
                    ((Hs.coerce
                        @(Hs.Vector Opentelemetry.Proto.Metrics.V1.Metrics.Exemplar)
                       ...
                       exponentialHistogramDataPointExemplars)))
              (HsProtobuf.encodeMessageField
                 (HsProtobuf.FieldNumber 12) exponentialHistogramDataPointMin))
           (HsProtobuf.encodeMessageField
              (HsProtobuf.FieldNumber 13) exponentialHistogramDataPointMax))
        (HsProtobuf.encodeMessageField
...
instance (HsJSONPB.ToJSONPB ExponentialHistogramDataPoint) where
  toJSONPB
    (ExponentialHistogramDataPoint f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11
                                   f12 f13 f14)
    = HsJSONPB.object
        ["attributes"
           .=
         ...
         "exemplars"
           .=
             ((Hs.coerce
                 ...
                 @(HsProtobuf.NestedVec Opentelemetry.Proto.Metrics.V1.Metrics.Exemplar))
                f11),
         "min" .= f12, "max" .= f13, "zero_threshold" .= f14]
  toEncodingPB
    (ExponentialHistogramDataPoint f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11
                                   f12 f13 f14)
    = HsJSONPB.pairs
...
instance (HsJSONPB.ToSchema ExponentialHistogramDataPoint) where
  declareNamedSchema _
    = do let declare_attributes = HsJSONPB.declareSchemaRef
         exponentialHistogramDataPointAttributes <- declare_attributes
                                                      Proxy.Proxy
         let declare_start_time_unix_nano = HsJSONPB.declareSchemaRef
         exponentialHistogramDataPointStartTimeUnixNano <- declare_start_time_unix_nano
                                                             Proxy.Proxy
         let declare_time_unix_nano = HsJSONPB.declareSchemaRef
         exponentialHistogramDataPointTimeUnixNano <- declare_time_unix_nano
                                                        Proxy.Proxy
         let declare_count = HsJSONPB.declareSchemaRef
         ...
         exponentialHistogramDataPointZeroCount <- declare_zero_count
                                                     Proxy.Proxy
         let declare_positive = HsJSONPB.declareSchemaRef
         exponentialHistogramDataPointPositive <- declare_positive
                                                    Proxy.Proxy
         let declare_negative = HsJSONPB.declareSchemaRef
         exponentialHistogramDataPointNegative <- declare_negative
                                                    Proxy.Proxy
         let declare_flags = HsJSONPB.declareSchemaRef
         exponentialHistogramDataPointFlags <- declare_flags Proxy.Proxy
         let declare_exemplars = HsJSONPB.declareSchemaRef
         exponentialHistogramDataPointExemplars <- declare_exemplars
                                                     Proxy.Proxy
         let declare_min = HsJSONPB.declareSchemaRef
         ...
         exponentialHistogramDataPointZeroThreshold <- declare_zero_threshold
                                                         Proxy.Proxy
         let _ = Hs.pure ExponentialHistogramDataPoint
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.NestedVec Opentelemetry.Proto.Common.V1.Common.KeyValue)
                         @(Hs.Vector Opentelemetry.Proto.Common.V1.Common.KeyValue))
         ...
         Hs.return
           HsJSONPB.NamedSchema
             {HsJSONPB._namedSchemaName = Hs.Just
                                            "ExponentialHistogramDataPoint",
              HsJSONPB._namedSchemaSchema = Hs.mempty
                                              {HsJSONPB._schemaParamSchema = Hs.mempty
                                                                               {HsJSONPB._paramSchemaType = Hs.Just
                                               ...
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("attributes", 
                                                                               ...
                                                                               ("zero_threshold", 
                                                                                exponentialHistogramDataPointZeroThreshold)]}}
data ExponentialHistogramDataPoint_Buckets
  = ExponentialHistogramDataPoint_Buckets {exponentialHistogramDataPoint_BucketsOffset :: Hs.Int32,
...
instance (HsProtobuf.Message ExponentialHistogramDataPoint_Buckets) where
  encodeMessage
    _
    ExponentialHistogramDataPoint_Buckets {exponentialHistogramDataPoint_BucketsOffset,
...
instance (HsJSONPB.ToSchema ExponentialHistogramDataPoint_Buckets) where
  declareNamedSchema _
    = do let declare_offset = HsJSONPB.declareSchemaRef
         exponentialHistogramDataPoint_BucketsOffset <- declare_offset
                                                          Proxy.Proxy
         let declare_bucket_counts = HsJSONPB.declareSchemaRef
         exponentialHistogramDataPoint_BucketsBucketCounts <- declare_bucket_counts
                                                                Proxy.Proxy
         let _ = Hs.pure ExponentialHistogramDataPoint_Buckets
                   <*>
                     ((HsProtobuf.coerceOver @(HsProtobuf.Signed Hs.Int32) @Hs.Int32)
...
data SummaryDataPoint
  = SummaryDataPoint {summaryDataPointAttributes :: (Hs.Vector Opentelemetry.Proto.Common.V1.Common.KeyValue),
...
instance (HsProtobuf.Message SummaryDataPoint) where
  encodeMessage
    _
    SummaryDataPoint {summaryDataPointAttributes,
                      summaryDataPointStartTimeUnixNano, summaryDataPointTimeUnixNano,
                      summaryDataPointCount, summaryDataPointSum,
                      summaryDataPointQuantileValues, summaryDataPointFlags}
    = Hs.mappend
        (Hs.mappend
           (Hs.mappend
              (Hs.mappend
              ...
              (HsProtobuf.encodeMessageField
                 (HsProtobuf.FieldNumber 5) summaryDataPointSum))
           (HsProtobuf.encodeMessageField
              (HsProtobuf.FieldNumber 6)
              ((Hs.coerce
        ...
        (HsProtobuf.encodeMessageField
           (HsProtobuf.FieldNumber 8) summaryDataPointFlags)
  decodeMessage _
...
instance (HsJSONPB.ToSchema SummaryDataPoint) where
  declareNamedSchema _
    = do let declare_attributes = HsJSONPB.declareSchemaRef
         ...
         let declare_start_time_unix_nano = HsJSONPB.declareSchemaRef
         summaryDataPointStartTimeUnixNano <- declare_start_time_unix_nano
                                                Proxy.Proxy
         let declare_time_unix_nano = HsJSONPB.declareSchemaRef
         ...
         summaryDataPointQuantileValues <- declare_quantile_values
                                             Proxy.Proxy
         let declare_flags = HsJSONPB.declareSchemaRef
         summaryDataPointFlags <- declare_flags Proxy.Proxy
         let _ = Hs.pure SummaryDataPoint
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.NestedVec Opentelemetry.Proto.Common.V1.Common.KeyValue)
                         @(Hs.Vector Opentelemetry.Proto.Common.V1.Common.KeyValue))
...
data SummaryDataPoint_ValueAtQuantile
  = SummaryDataPoint_ValueAtQuantile {summaryDataPoint_ValueAtQuantileQuantile :: Hs.Double,
...
instance (HsProtobuf.Message SummaryDataPoint_ValueAtQuantile) where
  encodeMessage
    _
    SummaryDataPoint_ValueAtQuantile {summaryDataPoint_ValueAtQuantileQuantile,
    ...
    = Hs.mappend
        ...
        (HsProtobuf.encodeMessageField
           (HsProtobuf.FieldNumber 2) summaryDataPoint_ValueAtQuantileValue)
  decodeMessage _
...
instance (HsJSONPB.FromJSONPB SummaryDataPoint_ValueAtQuantile) where
  parseJSONPB
    = HsJSONPB.withObject
        ...
        (\ obj
           -> Hs.pure SummaryDataPoint_ValueAtQuantile <*> obj .: "quantile"
                <*> obj .: "value")
...
instance (HsJSONPB.ToSchema SummaryDataPoint_ValueAtQuantile) where
  declareNamedSchema _
    = do let declare_quantile = HsJSONPB.declareSchemaRef
         summaryDataPoint_ValueAtQuantileQuantile <- declare_quantile
                                                       Proxy.Proxy
         let declare_value = HsJSONPB.declareSchemaRef
         summaryDataPoint_ValueAtQuantileValue <- declare_value Proxy.Proxy
         let _ = Hs.pure SummaryDataPoint_ValueAtQuantile
                                               ...
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("quantile", 
                                                                               ...
                                                                               ("value", 
                                                                                summaryDataPoint_ValueAtQuantileValue)]}}
data Exemplar
  = Exemplar {exemplarFilteredAttributes :: (Hs.Vector Opentelemetry.Proto.Common.V1.Common.KeyValue),
...
instance (HsProtobuf.Message Exemplar) where
  encodeMessage
    _
    Exemplar {exemplarFilteredAttributes, exemplarTimeUnixNano,
              exemplarValue, exemplarSpanId, exemplarTraceId}
    = Hs.mappend
        (Hs.mappend
           (Hs.mappend
              (Hs.mappend
                 ...
                 Hs.Just x
                   -> case x of
                        ExemplarValueAsDouble y
                          -> HsProtobuf.encodeMessageField
                               (HsProtobuf.FieldNumber 3) (HsProtobuf.ForceEmit y)
...
instance (HsJSONPB.ToSchema Exemplar) where
  declareNamedSchema _
    = do let declare_filtered_attributes = HsJSONPB.declareSchemaRef
         exemplarFilteredAttributes <- declare_filtered_attributes
                                         Proxy.Proxy
         let declare_time_unix_nano = HsJSONPB.declareSchemaRef
                                               ...
                                               HsJSONPB._schemaProperties = HsJSONPB.insOrdFromList
                                                                              [("filtered_attributes", 
                                                                               ...
                                                                               ("trace_id", 
                                                                                exemplarTraceId)]}}
data ExemplarValue
  = ExemplarValueAsDouble Hs.Double | ExemplarValueAsInt Hs.Int64
  deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)
...
instance (HsJSONPB.ToSchema ExemplarValue) where
  declareNamedSchema _
    = do let declare_as_double = HsJSONPB.declareSchemaRef
         ...
         let _ = Hs.pure ExemplarValueAsDouble
                   <*> HsJSONPB.asProxy declare_as_double
         let declare_as_int = HsJSONPB.declareSchemaRef
         exemplarValueAsInt <- declare_as_int Proxy.Proxy
         let _ = Hs.pure ExemplarValueAsInt
                   <*>
                     ((HsProtobuf.coerceOver
                         @(HsProtobuf.Signed (HsProtobuf.Fixed Hs.Int64)) @Hs.Int64)
                        (HsJSONPB.asProxy declare_as_int))
