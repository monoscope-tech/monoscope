...
data Routes' mode = Routes'
  { logExplorerGet :: mode :- "log_explorer" :> QPT "query" :> QPT "cols" :> QPT "since" :> QPT "from" :> QPT "to" :> QPT "layout" :> QPT "source" :> HXRequest :> HXBoosted :> Get '[HTML] (RespHeaders Log.LogsGet)
