...
adonisGuide apikey = do
  section_ [class_ "flex flex-col gap-10"] do
    ...
    div_ [class_ "w-full flex flex-col gap-2"] do
      ...
      p_ [class_ "text-gray-600 font-medium max-w-5xl"] "The SDK has accepts other options alongside API Key to allow you to customize the sdk. Redacting sensitive fields, debug mode etc"
