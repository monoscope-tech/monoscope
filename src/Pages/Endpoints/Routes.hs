...
data Routes' mode = Routes'
  { endpointListGet :: mode :- "endpoints" :> QPT "page" :> QPT "layout" :> QPT "filter" :> QPT "host" :> QPT "project_host" :> QPT "sort" :> HXRequest :> HXBoosted :> HXCurrentURL :> Get '[HTML] (RespHeaders EndpointList.EndpointRequestStatsVM)
