        ...
        div_ [class_ "mt-10"] do
          ...
          div_ [class_ "flex flex-col gap-4 border p-6 rounded-2xl"] do
            ...
            div_ [class_ "bg-gray-100 p-6"] do
              ...
              a_ [href_ $ "https://slack.com/oauth/v2/authorize?client_id=6211090672305.6200958370180&scope=chat:write,incoming-webhook&user_scope=&redirect_uri=https://app.apitoolkit.io/slack/oauth/callback/" <> pid, class_ "mt-4"] do
