...
data Routes' mode = Routes'
  ...
  , -- , onboardingProfilePost :: mode :- "onboarding" :> "profile" :> ReqBody '[FormUrlEncoded] Onboarding.ProfileForm :> Post '[HTML] (RespHeaders OnboardingV.OnboardingResponse)
    onboardingHostingGet :: mode :- "onboarding" :> "hosting" :> Get '[HTML] (RespHeaders OnboardingV.OnboardingResponse)
  , -- , onboardingHostingPost :: mode :- "onboarding" :> "hosting" :> ReqBody '[FormUrlEncoded] Onboarding.HostingLocation :> Post '[HTML] (RespHeaders OnboardingV.OnboardingResponse)
    onboardingUsageGet :: mode :- "onboarding" :> "usage" :> Get '[HTML] (RespHeaders OnboardingV.OnboardingResponse)
  , -- , onboardingUsagePost :: mode :- "onboarding" :> "usage" :> ReqBody '[FormUrlEncoded] Onboarding.UsagePreferences :> Post '[HTML] (RespHeaders OnboardingV.OnboardingResponse)
    onboardingUrlMonitorGet :: mode :- "onboarding" :> "url-monitor" :> Get '[HTML] (RespHeaders OnboardingV.OnboardingResponse)
  , -- , onboardingUrlMonitorPost :: mode :- "onboarding" :> "url-monitor" :> ReqBody '[FormUrlEncoded] Onboarding.URLMonitorConfig :> Post '[HTML] (RespHeaders OnboardingV.OnboardingResponse)
    onboardingNotificationsGet :: mode :- "onboarding" :> "notifications" :> Get '[HTML] (RespHeaders OnboardingV.OnboardingResponse)
  , -- , onboardingNotificationsPost :: mode :- "onboarding" :> "notifications" :> ReqBody '[FormUrlEncoded] Onboarding.NotificationSettings :> Post '[HTML] (RespHeaders OnboardingV.OnboardingResponse)
    onboardingTeamGet :: mode :- "onboarding" :> "team" :> Get '[HTML] (RespHeaders OnboardingV.OnboardingResponse)
  , -- , onboardingTeamPost :: mode :- "onboarding" :> "team" :> ReqBody '[FormUrlEncoded] Onboarding.TeamInvitation :> Post '[HTML] (RespHeaders OnboardingV.OnboardingResponse)
    onboardingPricingGet :: mode :- "onboarding" :> "pricing" :> Get '[HTML] (RespHeaders OnboardingV.OnboardingResponse)
  , -- , onboardingPricingPost :: mode :- "onboarding" :> "pricing" :> ReqBody '[FormUrlEncoded] Onboarding.PricingPlan :> Post '[HTML] (RespHeaders OnboardingV.OnboardingResponse)
