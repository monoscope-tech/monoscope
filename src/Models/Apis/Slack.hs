...
insertAccessToken :: (WithConnection :> es, IOE :> es) => Projects.ProjectId -> Text -> Text -> Text -> Eff es Int64
...
getProjectSlackData :: (WithConnection :> es, IOE :> es) => Projects.ProjectId -> Eff es (Maybe SlackData)
...
getSlackDataByTeamId :: (WithConnection :> es, IOE :> es) => Text -> Eff es (Maybe SlackData)
...
insertDiscordData :: (WithConnection :> es, IOE :> es) => Projects.ProjectId -> Text -> Eff es Int64
...
getDiscordData :: (WithConnection :> es, IOE :> es) => Text -> Eff es (Maybe DiscordData)
...
getDiscordDataByProjectId :: (WithConnection :> es, IOE :> es) => Projects.ProjectId -> Eff es (Maybe DiscordData)
...
updateDiscordNotificationChannel :: (WithConnection :> es, IOE :> es) => Text -> Text -> Eff es Int64
...
updateSlackNotificationChannel :: (WithConnection :> es, IOE :> es) => Text -> Text -> Eff es Int64
...
getDashboardsForSlack :: (WithConnection :> es, IOE :> es) => Text -> Eff es (V.Vector (Text, Text))
...
getDashboardsForWhatsapp :: (WithConnection :> es, IOE :> es) => Text -> Eff es (V.Vector (Text, Text))
...
getDashboardsForDiscord :: (WithConnection :> es, IOE :> es) => Text -> Eff es (V.Vector (Text, Text))
