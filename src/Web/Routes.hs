...
data TelemetryRoutes' mode = TelemetryRoutes'
  ...
  , metricRelatedGetH :: mode :- "metrics" :> "details" :> Capture "metric_name" Text :> "related" :> QPT "metric_source" :> Get '[HTML] (RespHeaders (Html ()))
  ...
  , kubernetesDetailGetH :: mode :- "infrastructure" :> "kubernetes" :> "detail" :> QPT "resource" :> QPT "name" :> QPT "cluster" :> QPT "namespace" :> QPT "from" :> QPT "to" :> QPT "since" :> Get '[HTML] (RespHeaders Infrastructure.KubernetesDetailGet)
...
data ProjectsRoutes' mode = ProjectsRoutes'
  ...
  , membersDeleteH :: mode :- "p" :> Capture "projectId" Projects.ProjectId :> "manage_members" :> Capture "memberId" ProjectMembers.ProjectMemberId :> Delete '[HTML] (RespHeaders (Html ()))
...
telemetryServer pid =
  TelemetryRoutes'
    ...
    , metricRelatedGetH = Metrics.metricRelatedGetH pid
    ...
    , imageDetailGetH = Infrastructure.imageDetailGetH pid
    , kubernetesGetH = Infrastructure.kubernetesGetH pid
    , kubernetesDetailGetH = Infrastructure.kubernetesDetailGetH pid
