...
export const completionTheme = EditorView.theme({
  ...
  '.query-completion-dropdown.cm-tooltip-autocomplete ul completion-section': { padding: '8px 16px', fontWeight: '600', textTransform: 'uppercase', backgroundColor: 'var(--color-fillWeaker, #f4f5f8)', borderBottom: '1px solid var(--color-strokeWeak, GrayText)' },
