...
export const completionTheme = EditorView.theme({
  ...
  '.query-completion-dropdown.cm-tooltip-autocomplete ul': { order: '0', flex: '1 1 auto', minHeight: '0', maxHeight: 'none !important', fontFamily: 'inherit', padding: '0', overscrollBehavior: 'contain' },
  '.query-completion-dropdown.cm-tooltip-autocomplete ul li[role=option]': { display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 16px', minHeight: '36px', boxSizing: 'border-box', borderBottom: '1px solid var(--color-strokeWeak, GrayText)' },
  ...
  '.query-completion-dropdown.cm-tooltip-autocomplete completion-section': { padding: '8px 16px', fontWeight: '600', textTransform: 'uppercase', backgroundColor: 'var(--color-fillWeaker, #f4f5f8)', borderBottom: '1px solid var(--color-strokeWeak, GrayText)' },
  ...
  '.query-completion-hint': { display: 'none', order: '-1', padding: '8px 16px', color: 'var(--color-textWeak, inherit)', backgroundColor: 'var(--color-fillWeaker, #f4f5f8)', borderBottom: '1px solid var(--color-strokeWeak, GrayText)' },
  '.query-completion-empty .query-completion-hint': { display: 'block' },
  '.query-completion-help': { order: '1', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', gap: '8px', padding: '8px 16px', color: 'var(--color-textWeak, inherit)', borderTop: '1px solid var(--color-strokeWeak, GrayText)' },
