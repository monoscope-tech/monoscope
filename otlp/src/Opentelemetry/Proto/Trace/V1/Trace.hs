...
newtype TracesData = TracesData {tracesDataResourceSpans :: (Hs.Vector Opentelemetry.Proto.Trace.V1.Trace.ResourceSpans)}
...
data ResourceSpans = ResourceSpans
  { resourceSpansResource :: (Hs.Maybe Opentelemetry.Proto.Resource.V1.Resource.Resource)
...
data ScopeSpans = ScopeSpans
  { scopeSpansScope :: (Hs.Maybe Opentelemetry.Proto.Common.V1.Common.InstrumentationScope)
...
data Span_Link = Span_Link
  { span_LinkTraceId :: Hs.ByteString
